...
public class CourseAsserts {
    ...
    public static void assertCourseUpdatableRelationshipsEquals(Course expected, Course actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getZones()).as("check zones").isEqualTo(expected.getZones()))
            .satisfies(a -> assertThat(a.getTrainer()).as("check trainer").isEqualTo(expected.getTrainer()));
    }
}
