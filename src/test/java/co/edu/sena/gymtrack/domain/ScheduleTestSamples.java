...
public class ScheduleTestSamples {
    ...
    public static Schedule getScheduleSample1() {
        return new Schedule().id(1L).dayOfWeek("dayOfWeek1");
    }

    public static Schedule getScheduleSample2() {
        return new Schedule().id(2L).dayOfWeek("dayOfWeek2");
    }

    public static Schedule getScheduleRandomSampleGenerator() {
        return new Schedule().id(longCount.incrementAndGet()).dayOfWeek(UUID.randomUUID().toString());
    }
}
