...
class InvoiceResourceIT {
    ...
    public static Invoice createEntity(EntityManager em) {
        Invoice invoice = new Invoice().total(DEFAULT_TOTAL).createdDate(DEFAULT_CREATED_DATE);
        // Add required entity
    ...
    public static Invoice createUpdatedEntity(EntityManager em) {
        Invoice updatedInvoice = new Invoice().total(UPDATED_TOTAL).createdDate(UPDATED_CREATED_DATE);
        // Add required entity
        PaymentMethod paymentMethod;
        if (TestUtil.findAll(em, PaymentMethod.class).isEmpty()) {
        ...
        updatedInvoice.setPaymentMethod(paymentMethod);
        // Add required entity
        UserData userData;
        if (TestUtil.findAll(em, UserData.class).isEmpty()) {
        ...
        updatedInvoice.setUserData(userData);
    ...
    void putExistingInvoice() throws Exception {
        ...
        updatedInvoice.total(UPDATED_TOTAL).createdDate(UPDATED_CREATED_DATE);
    ...
    void fullUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.total(UPDATED_TOTAL).createdDate(UPDATED_CREATED_DATE);
