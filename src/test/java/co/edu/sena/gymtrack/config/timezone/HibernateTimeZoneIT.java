package co.edu.sena.gymtrack.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import co.edu.sena.gymtrack.IntegrationTest;
import co.edu.sena.gymtrack.repository.timezone.DateTimeWrapper;
import co.edu.sena.gymtrack.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM qm_date_time_wrapper where id=%d", fieldName, id);
    }
