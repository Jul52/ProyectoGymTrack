...
/**
 * Service Interface for managing {@link co.edu.sena.gymtrack.domain.Payment}.
 */
public interface PaymentService {
    ...
    /**
     * Get all the PaymentDTO where Invoice is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<PaymentDTO> findAllWhereInvoiceIsNull();
