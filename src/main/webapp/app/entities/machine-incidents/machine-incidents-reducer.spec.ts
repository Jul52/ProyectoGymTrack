...
import reducer, {
  ...
  reset,
  updateEntity,
} from './machine-incidents.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MACHINEINCIDENTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MACHINEINCIDENTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MACHINEINCIDENTS actions', async () => {
      const arg = { id: 31497 };
    ...
    it('dispatches UPDATE_MACHINEINCIDENTS actions', async () => {
      const arg = { id: 31497 };
    ...
    it('dispatches PARTIAL_UPDATE_MACHINEINCIDENTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MACHINEINCIDENTS actions', async () => {
      const arg = 42666;
