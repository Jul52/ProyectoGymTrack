...
export const ScheduleDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gymtrackApp.schedule.delete.question">
        <Translate contentKey="gymtrackApp.schedule.delete.question" interpolate={{ id: scheduleEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="qm-confirm-delete-schedule" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
