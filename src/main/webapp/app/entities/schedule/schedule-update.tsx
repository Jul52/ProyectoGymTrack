  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gymtrackApp.schedule.home.createOrEditLabel" data-cy="ScheduleCreateUpdateHeading">
            <Translate contentKey="gymtrackApp.schedule.home.createOrEditLabel">Create or edit a Schedule</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gymtrackApp.schedule.dayOfWeek')}
              ...
              />
              <ValidatedField
                label={translate('gymtrackApp.schedule.startTime')}
              ...
              />
              <ValidatedField
                label={translate('gymtrackApp.schedule.endTime')}
                id="schedule-endTime"
                name="endTime"
                data-cy="endTime"
                type="datetime-local"
              ...
              <ValidatedField
                ...
                name="course"
                data-cy="course"
                label={translate('gymtrackApp.schedule.course')}
                type="select"
                required
              >
                <option value="" key="0" />
