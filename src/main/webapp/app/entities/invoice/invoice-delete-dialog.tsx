...
export const InvoiceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gymtrackApp.invoice.delete.question">
        <Translate contentKey="gymtrackApp.invoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="qm-confirm-delete-invoice" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
