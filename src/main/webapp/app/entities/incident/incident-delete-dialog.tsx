...
export const IncidentDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/incident${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gymtrackApp.incident.delete.question">
        <Translate contentKey="gymtrackApp.incident.delete.question" interpolate={{ id: incidentEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="qm-confirm-delete-incident" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
