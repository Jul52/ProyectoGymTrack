  ...
  return (
    <div>
      <h2 id="document-type-heading" data-cy="DocumentTypeHeading">
        <Translate contentKey="gymtrackApp.documentType.home.title">Document Types</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gymtrackApp.documentType.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/document-type/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gymtrackApp.documentType.home.createLabel">Create new Document Type</Translate>
          </Link>
        </div>
      </h2>
        ...
        {documentTypeList && documentTypeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gymtrackApp.documentType.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/document-type/${documentType.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gymtrackApp.documentType.home.notFound">No Document Types found</Translate>
            </div>
          )
        )}
      </div>
