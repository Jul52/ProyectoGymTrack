...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GYMSERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GYMSERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GYMSERVICE actions', async () => {
      const arg = { id: 21006 };
    ...
    it('dispatches UPDATE_GYMSERVICE actions', async () => {
      const arg = { id: 21006 };
    ...
    it('dispatches PARTIAL_UPDATE_GYMSERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GYMSERVICE actions', async () => {
      const arg = 42666;
