  ...
  return (
    <div>
      <h2 id="payment-method-heading" data-cy="PaymentMethodHeading">
        <Translate contentKey="gymtrackApp.paymentMethod.home.title">Payment Methods</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gymtrackApp.paymentMethod.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/payment-method/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="gymtrackApp.paymentMethod.home.createLabel">Create new Payment Method</Translate>
          </Link>
        </div>
      </h2>
        ...
        {paymentMethodList && paymentMethodList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gymtrackApp.paymentMethod.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('methodName')}>
                  <Translate contentKey="gymtrackApp.paymentMethod.methodName">Method Name</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gymtrackApp.paymentMethod.home.notFound">No Payment Methods found</Translate>
            </div>
          )
        )}
      </div>
