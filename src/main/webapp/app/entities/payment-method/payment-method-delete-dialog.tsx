...
export const PaymentMethodDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gymtrackApp.paymentMethod.delete.question">
        <Translate contentKey="gymtrackApp.paymentMethod.delete.question" interpolate={{ id: paymentMethodEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="qm-confirm-delete-paymentMethod" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
