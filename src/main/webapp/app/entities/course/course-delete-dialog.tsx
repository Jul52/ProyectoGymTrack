...
export const CourseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gymtrackApp.course.delete.question">
        <Translate contentKey="gymtrackApp.course.delete.question" interpolate={{ id: courseEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="qm-confirm-delete-course" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
