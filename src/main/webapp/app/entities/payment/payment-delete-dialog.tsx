...
export const PaymentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gymtrackApp.payment.delete.question">
        <Translate contentKey="gymtrackApp.payment.delete.question" interpolate={{ id: paymentEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="qm-confirm-delete-payment" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
