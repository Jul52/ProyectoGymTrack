...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './machine.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MACHINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MACHINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MACHINE actions', async () => {
      const arg = { id: 9429 };
    ...
    it('dispatches UPDATE_MACHINE actions', async () => {
      const arg = { id: 9429 };
    ...
    it('dispatches PARTIAL_UPDATE_MACHINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MACHINE actions', async () => {
      const arg = 42666;
