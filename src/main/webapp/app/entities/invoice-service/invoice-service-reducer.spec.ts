...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVOICESERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVOICESERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVOICESERVICE actions', async () => {
      const arg = { id: 8211 };
    ...
    it('dispatches UPDATE_INVOICESERVICE actions', async () => {
      const arg = { id: 8211 };
    ...
    it('dispatches PARTIAL_UPDATE_INVOICESERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVOICESERVICE actions', async () => {
      const arg = 42666;
