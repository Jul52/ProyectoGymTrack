...
export const UserDataDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/user-data${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gymtrackApp.userData.delete.question">
        <Translate contentKey="gymtrackApp.userData.delete.question" interpolate={{ id: userDataEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="qm-confirm-delete-userData" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
